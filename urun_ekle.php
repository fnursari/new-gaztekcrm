        ...
        <div class="col-md-12 ">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <form action="urun_ekle_islem.php" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_genel">
                                   ...
                                   <!--  <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="grm_no" id="grm_no" class="form-control" value="">
                                        </div>
                                    </div> -->
                                    <!-- <div class="form-group">
                                        <label class="col-md-2 control-label">Oem Kodu</label>
                                        <div class="col-md-8">
                                            <input type="text" name="oem_no" id="oem_no" class="form-control" value="">
                                        </div>
                                    </div> -->
                                   <!--  <div class="form-group">
                                        <label class="col-md-2 control-label">Cross Kodu</label>
                                        <div class="col-md-8">
                                            <input type="text" name="cross_no" id="cross_no" class="form-control" value="">
                                        </div>
                                    </div> -->
                                    <!-- <div class="form-group">
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="marka" id="marka" class="form-control" value="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <!-- <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="file" name="pdf_<?php echo $code?>" >
                                                            </div>
                                                        </div> -->
                                                        <!-- <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" name="seo_keyword_<?php echo $code?>" id="seo_keyword_<?php echo $code?>"  class="form-control" data-role="tagsinput">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <!-- <div class="form-group last">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea class="form-control" name="aciklama_<?php echo $code?>" id="aciklama_<?php echo $code?>" rows="4" ></textarea>
                                                            </div>
                                                        </div> -->
                                                        <div class="form-group last">
                                                            <label class="control-label col-md-2">Genel Özellikler</label>
                                                            <div class="col-md-8">
                                                                <textarea class="ckeditor form-control" name="urun_icerik_<?php echo $code?>" id="urun_icerik_<?php echo $code?>" rows="6" data-error-container="#editor2_error"></textarea>
                                                        ...
                                                        <div class="form-group last">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea class="ckeditor form-control" name="teknik_tablo_<?php echo $code?>" id="teknik_tablo_<?php echo $code?>" rows="6" data-error-container="#editor2_error"></textarea>
                                                                <div id="editor2_error"> </div>
                                                            </div>
                                                        </div>
