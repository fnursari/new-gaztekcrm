...
if($_SESSION["user"]["auth"]==md5(session_id()."vizyoner")) {
	...
	$blog_guncelle="update blog set blog_baslik_tr='$blog_baslik_tr',blog_baslik_en='$blog_baslik_en',blog_baslik_ru='$blog_baslik_ru',blog_baslik_ar='$blog_baslik_ar',blog_baslik_fr='$blog_baslik_fr',blog_baslik_de='$blog_baslik_de'";
	$blog_guncelle.=",blog_tarih='$blog_tarih',blog_icerik_tr='$blog_icerik_tr',blog_icerik_en='$blog_icerik_en',blog_icerik_ru='$blog_icerik_ru',blog_icerik_ar='$blog_icerik_ar',blog_icerik_fr='$blog_icerik_fr',blog_icerik_de='$blog_icerik_de'";
	if($resim!="") $blog_guncelle.=" ,resim_buyuk='$resized_image',resim_kucuk='$resized_thumb'";
	$blog_guncelle.=" where blog_id='$blog_id'";
	$db->query($blog_guncelle);
	header("location:admin.php?cmd=blog_guncelle&blog_id=$blog_id&result=guncellendi");
}
?>