...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "musamert2/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "musamert2/upload";
        
$username = "admin"; $password = '21232f297a57a5a743894a0e4a801fc3';

    $useruploadfolder = "moramill/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "moramill/upload";
    ...
    $useruploadfolder = "himak/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "himak/upload";
        

    $useruploadfolder = "aktivdegirmen/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "aktivdegirmen/upload";
        

    $useruploadfolder = "kameshwelding/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "kameshwelding/upload";
        

    $useruploadfolder = "newcity/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "newcity/upload";
        

    $useruploadfolder = "niskontarim/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "niskontarim/upload";
        

    $useruploadfolder = "otojen/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "otojen/upload";
        

    $useruploadfolder = "otojen/gaz/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "otojen/gaz/upload";
        

    $useruploadfolder = "rekparsan.com/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "rekparsan.com/upload";
        

    $useruploadfolder = "girmanotomotiv.com/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "girmanotomotiv.com/upload";
        

    $useruploadfolder = "girmanotomotiv/upload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "girmanotomotiv/upload";
