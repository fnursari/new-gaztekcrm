...
if(canUserAccessAdminArea()) {
	...
	$where 		= ["bilgi_giris_id"	=>	$bilgi_giris_id];
	updateTableData("bilgi_giris",$updateData,$where);
	...
	updateTableData("teklifler",$teklifUpdateData,$where);
...
*/	header("location:admin.php?cmd=bilgi_giris_guncelle&bilgi_giris_id=$bilgi_giris_id&result=guncellendi");
}
?>
